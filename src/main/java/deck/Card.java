...
public class Card extends JButton implements Comparable<Card>{
    ...
    public Card(Rank rank, Suit suit){
        this.rank = rank;
        this.suit = suit;
        setIcon(new ImageIcon(new ImageIcon(Card.class.getClassLoader().getResource("CribbageGUI_Images/Cards/" + this + ".png")).getImage().getScaledInstance(80, 150, Image.SCALE_SMOOTH)));
    ...
    public static Card getBlankCard(){
        ...
        tempCard.setIcon(new ImageIcon(new ImageIcon(Card.class.getClassLoader().getResource("CribbageGUI_Images/Cards/Card_Back.png")).getImage().getScaledInstance(80, 150, Image.SCALE_SMOOTH)));
        return tempCard;
    }
